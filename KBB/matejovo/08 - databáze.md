...
1. [08 - Databáze](#08---databáze)
   1. [Co je to databáze](#co-je-to-databáze)
      1. [Databáze vs. soubor](#databáze-vs-soubor)
      2. [DBMS - Database Managemet System](#dbms---database-managemet-system)
      3. [Typy databází](#typy-databází)
         1. [Relační databáze (SQL)](#relační-databáze-sql)
         2. [NoSQL databáze](#nosql-databáze)
         3. [In-memory databáze](#in-memory-databáze)
      4. [Využití databází](#využití-databází)

2. [Relační databáze](#relační-databáze)
   1. [Základní pojmy](#základní-pojmy)
   2. [Datové typy](#datové-typy)
   3. [Relace mezi tabulkami](#relace-mezi-tabulkami)

3. [SQL - Structured Query Language](#sql---structured-query-language)
   1. [Základní příkazy](#základní-příkazy)
      1. [`SELECT` - Výběr dat](#select---výběr-dat)
      2. [`INSERT` - Přidání nového záznamu](#insert---přidání-nového-záznamu)
      3. [`UPDATE` - Aktualizace dat](#update---aktualizace-dat)
      4. [`DELETE` - Mazání dat](#delete---mazání-dat)
   2. [Tvorba a správa struktury](#tvorba-a-správa-struktury)
      1. [`CREATE` - Vytvoření databáze/tabulky](#create---vytvoření-databázetabulky)
         1. [Vytvoření databáze](#vytvoření-databáze)
         2. [Vytvoření tabulky](#vytvoření-tabulky)
      2. [`ALTER` - Změna struktury tabulky](#alter---změna-struktury-tabulky)
         1. [Přidání sloupce](#přidání-sloupce)
         2. [Smazání sloupce](#smazání-sloupce)
         3. [Změna sloupce](#změna-sloupce)
   3. [`DROP` - Smazání tabulky nebo databáze](#drop---smazání-tabulky-nebo-databáze)
   4. [Pokročilé dotazy](#pokročilé-dotazy)
      1. [`JOIN` – spojování tabulek](#join--spojování-tabulek)
         1. [`INNER JOIN`](#inner-join)
         2. [`LEFT JOIN`](#left-join)
         3. [`RIGHT JOIN`](#right-join)
   5. [Agregační funkce](#agregační-funkce)
      1. [`COUNT()` – počet](#count--počet)
      2. [`SUM()` – součet](#sum--součet)
      3. [`AVG()` – průměr](#avg--průměr)
      4. [`MIN()` a `MAX()`](#min-a-max)
   6. [Filtrování a řazení](#filtrování-a-řazení)
      1. [`WHERE` – podmínka](#where--podmínka)
      2. [`AND` / `OR`](#and--or)
      3. [`LIKE` – hledání podle vzoru](#like--hledání-podle-vzoru)
      4. [`IN` – výběr z více možností](#in--výběr-z-více-možností)
      5. [`BETWEEN` – rozsah](#between--rozsah)
      6. [`GROUP BY` – seskupení](#group-by--seskupení)
      7. [`HAVING` – podmínka pro skupiny](#having--podmínka-pro-skupiny)
      8. [`ORDER BY` – řazení](#order-by--řazení)
...
5. [NoSQL databáze](#nosql-databáze)
   1. [Typy NoSQL databází](#typy-nosql-databází)
      1. [Dokumentové](#dokumentové)
      2. [Key-value - Redis](#key-value---redis)
      3. [Sloupcové - Apache Cassandra](#sloupcové---apache-cassandra)
      4. [Grafové - Neo4j](#grafové---neo4j)
   2. [Kdy použít NoSQL](#kdy-použít-nosql)
   3. [SQL vs NoSQL](#sql-vs-nosql)

6. [Populární databáze](#populární-databáze)
   1. [Relační](#relační)
   2. [NoSQL](#nosql)
